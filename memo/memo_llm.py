...
class MemoLLM:
    def __init__(self, pepper_ip, google_keyfile, openai_key_path, debug=False):
    ...
    def llm_action(self, dialog_history=''):
        ...
        base_prompt = (f"We willen graag dat je een rol speelt. Je bent Memo. Memo is een zorgrobot die graag praatjes maakt met mensen."
                       ...
                       f"Je gaat nu met 1 persoon praten. Stel je zelf eerst voor"
                       ...
                       f""
                       f"Je hebt zelf ook een doel. Om de 4 uitwisselingen vraag je of je een gedichtje mag voordragen."
                       f"Daarna wissel je van onderwerp."
                       ...
                       f"Stel maximaal twee vervolgvragen."
    ...
    def run(self, participant_id, speed=100):
        try:
            self.start_logging(participant_id)
            dialog_history = ''
            llm_response = ''
